        ...
        jQuery(function($) {
                ...
                jQuery(grid_selector).jqGrid({
                    ...
                    colModel:[
                        ...
                        {name:'role_name',index:'name', width:150,editable: true,editoptions:{size:"20",maxlength:"30"}},
                        {name:'rbac_route',index:'name', width:150,editable: true,editoptions:{size:"20",maxlength:"30"}},
